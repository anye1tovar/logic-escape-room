  ...
  useEffect(() => {
    ...
    (async () => {
      try {
        ...
        const searchEventId = generateMetaEventId("search");
        const searchParams = {
          search_string: date,
        ...
        trackMetaEvent("Search", searchParams, searchEventId);
        void trackServerMetaEvent("Search", searchParams, searchEventId);
        } catch (err) {
